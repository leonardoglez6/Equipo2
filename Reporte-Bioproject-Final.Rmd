...
diferencial con DESEq2. En nuestro caso, realizamos el análisis con R versión 4.4.1
dentro del cluster.
...
los datos y cargamos los metadatos.

# Expresión diferencial

Buscamos hacer nuestro análisis de exprsión diferencial a partir de los
datos obtenidos. El script correspondiente se puede encontrar dentro del
...
salida en el archivo `STEAP3_KD_vs_WT.RData` .
...
Finalmente, pudimos detectar un Batch Effect tras hacer el PCA de las
...
Knockdown, y guardamos los resultados en el archivio `DE_KD_vs_WT.csv`.
...
menor al 0.05. Y, sumado a ello, para clasificarlos como up-regulated
