...
+-----------------------+---------------------------------------------------------------+
| Método de selección   | Purificación de transcritos poliadenilados (poli-A)           |
+-----------------------+---------------------------------------------------------------+
| Número de             | 6                                                             |
| transcriptomas        |                                                               |
+-----------------------+---------------------------------------------------------------+
| Número de réplicas    | 3 replicas biológicas por condición (control y knockdown)     |
| biológicas            |                                                               |
+-----------------------+---------------------------------------------------------------+
| Secuenciador empleado | Illumina NovaSeq 6000                                         |
+-----------------------+---------------------------------------------------------------+
| Distribución de las   | -   **Control**: 3 réplicas biológicas WT (SRR31732089,       |
| muestras              |     SRR31732090, SRR31732091)                                 |
|                       |                                                               |
|                       | -   **Sobreexpresión**: 3 réplicas biológicas con knockdown   |
|                       |     de *STEAP3* (SRR31732086, SRR31732087, SRR31732088)\n     |
+-----------------------+---------------------------------------------------------------+
...
| lecturas              |                                                               |
+-----------------------+---------------------------------------------------------------+
| Artículo científico   | Zhao Z, Yu P, Wang Y, Li H et al. Silencing of STEAP3         |
|                       | suppresses cervical cancer cell proliferation and migration   |
|                       | via JAK/STAT3 signaling pathway. Cancer Metab 2024 Dec        |
|                       | 30;12(1):40. PM ID: [3973 675                                 |
|                       | 1                                                             |
|                       | ](htt%20%20%2%200%2%2%20%2000%20%20%20%20%20p%%20%20%%202020% |
|                       | 2%200s:%20%20%20%20%2%200//%20%%202%200ww%20w%%20%%202020%%2% |
|                       | 200%2020%%2020.%2%%20%20%20200n%%20%202%200c%20%2%200bi%2%200 |
|                       | %2%20%200.n%2%200%%20%2020%%2%20020%20%20l%20%2%200m.n%%%2020 |
|                       | 2%%2020%200i%%2%2002%%20200%20%%%2%20%200202%200h%2%%20200.%2 |
|                       | %20%200g%%20%20%%202%20%200%2020o%%20%202%20%200%20%20%20%20v |
|                       | %20/p%20%20%%2020ub%%2020%%202%20%200m%20%20ed/%203%2%2%2000% |
|                       | %%2020209%20%20%%20%20%2%200%20%2020%%%20%20%2020207%2%2%200% |
|                       | %20%20%2%2002003%20%%202%200%%%20%20%2%200202%20%2%2000%2%%20 |
|                       | 200%20%206%%20207%20%%%2020%%2020%2%200%202%%20%20200%205%20% |
|                       | %20%202%200%20%201%20%22Link%20t%20o%20%20PubMed%20record%22) |
+-----------------------+---------------------------------------------------------------+
...
Basado en el artículo "Silencing of *STEAP3* suppresses cervical cancer cell
proliferation and migration via *JAK/STAT3* signaling pathway” se comparó el 
perfil transcripcional, a partir de secuencias en archivos FASTQ de 6 muestras
de la línea celular HeLa divididas en 2 grupos, uno control y otro al que se 
deletó el gen *STEAP3*. Se realizó un alineamiento y conteo con STAR debido a 
la facilidad de trabajar con este programa ya que no se necesita crear un 
archivo .txi para importar los datos a R; posteriormente se realizó el análisis 
de expresión diferencial con DESeq2 y el enriquecimiento funcional con 
gProfiler2 y clusterprofiler para obtener un enriquecimiento de GO Biological 
Process y de KEGG pathways. Se encontraron 3 genes subregulados y 12 genes 
sobreexpresados, destacando los genes SERPINB3/4 asociados a la sensibilidad al 
tratamiento de cáncer cervical, además el gen *STEAP3* se encuentra subregulado 
como era esperado. La vía de la ferrotopsis se encuentra enriquecida debido a 
la subregulación de *STEAP3*, la cuál está relacionada con la muerte celular, 
el cuál es un mecanismo comúnmente relacionado con el cáncer.
