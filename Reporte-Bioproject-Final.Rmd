...
| transcriptomas          |                         |
+-------------------------+-------------------------+
| Número de réplicas      | 3 replicas biológicas   |
| biológicas              | por condición (control  |
|                         | y knockdown)            |
+-------------------------+-------------------------+
...
+-------------------------+-------------------------+
| Artículo científico     | Zhao Z, Yu P, Wang Y,   |
|                         | Li H et al. Silencing   |
|                         | of STEAP3 suppresses    |
...
|                         | 30;12(1):40. PM         |
|                         | ID: [3973 675           |
|                         | 1](htt%20%20%2%200%2%2  |
|                         | 00%20%20%20%20%20p%%20% |
|                         | 2020%2%200s:%20%20%20%2 |
|                         | 0//%20%%2020ww%20w%%20% |
|                         | 2020%%20%2020%%2020.%2% |
|                         | %20200n%%20%202%200c%20 |
|                         | bi%2%200%2%20%200.n%20% |
|                         | %2020%%2%20020%20l%20%2 |
|                         | 0m.n%%%20202%20%200i%%2 |
|                         | 02%%20200%%%2%20%200202 |
|                         | 0h%2%200.%2%20%200g%%20 |
|                         | %2%20%200%2020o%%20%202 |
|                         | 0%20%20%20%20v%20/p%20% |
|                         | 20ub%%2020%%202%200m%20 |
|                         | ed/%203%2%200%%%2020209 |
|                         | %20%%20%2%200%20%2020%% |
|                         | %2020207%2%2%200%%20%20 |
|                         | 2003%20%%202%200%%%20%2 |
|                         | 0202%20%2%2000%2%200%20 |
|                         | 6%%20207%20%%20%%2020%2 |
|                         | 0%202%%20200%205%20%%20 |
|                         | 2%200%201%20%22Link%20t |
|                         | o%20PubMed%20record%22) |
+-------------------------+-------------------------+
...
│   ├── fastqc_adapters.png
│   ├── fastqc_adapters_processed.png
│   ├── fastqc_per_base_n_content_plot-01.png
│   ├── fastqc_per_base_n_content_plot.png
│   ├── fastqc_per_base_sequence_quality_plot-01.png
│   ├── fastqc_per_base_sequence_quality_plot.png
│   ├── fastqc_per_sequence_gc_content_plot-01.png
│   ├── fastqc_per_sequence_gc_content_plot.png
│   ├── fastqc_per_sequence_quality_scores_plot-01.png
│   ├── fastqc_per_sequence_quality_scores_plot.png
│   ├── fastqc_sequence_duplication_levels_plot-01.png
...
│   ├── DE_KD_vs_WT.csv
│   ├── DOWN_GOKD_vs_WT.csv
│   ├── KEGG_enrichment_KD_vs_WT.csv
│   ├── STEAP3_KD_vs_WT.RData
│   ├── UP_GO_KD_vs_WT.csv
│   ├── counts
│   │   ├── raw_counts.RData
│   │   └── raw_counts.csv
...
│       └── barplotUP_GO_KD_vs_WT.png
└── scripts
    ├── 01_DownloadRawData.sh
    ├── 02_Quality_raw.sh
    ├── 03_Trimmed.sh
    ├── 04_Quality_trimmed.sh
    ├── 05_STAR_index.sh
    ├── 06_STAR_align.sh
    ├── 07_Load_data_STAR.R
    ├── 08_DEG_STAR_KD.R
    ├── 09_Visualization_data_STAR.R
    └── 10_GO_terms_STAR.R
```
