...
| muestras                   |     réplicas biológicas WT |
|                            |     (SRR31732089,          |
|                            |     SRR31732090,           |
|                            |     SRR31732091)           |
|                            |                            |
...
|                            | 675                        |
|                            | 1](htt%20%2                |
|                            | 0%20%20%20%20%20p%%20%2020 |
|                            | s:%20%20%20//%20%%2020www% |
|                            | 20%%20%2020%%2020.%20n%%20 |
|                            | 2%200c%20bi%20%2%200.n%20% |
|                            | 20%%2020%20l%20m.n%%%20202 |
|                            | 0i%%202%200%%%2%2002020h%2 |
|                            | 0.%2%200g%%2%20%200%2020o% |
|                            | 20%20%20%20v%20/p%20%20ub% |
|                            | 2%200m%20ed/%203%20%%20209 |
|                            | %%20%2%200%2020%%20207%2%2 |
|                            | 0%%202003%20%2%200%%%20202 |
|                            | %2%2000%20%206%207%20%%20% |
|                            | 20%202%200%205%20%%202%200 |
|                            | 1 "Link to PubMed record") |
+----------------------------+----------------------------+
...
para poder seleccionar las muestras.

Utilizamos el comando wget para las 12 muestras (6 muestras con su
respectiva lectura forward y reverse).

El script correspondiente se puede encontrar dentro del GitHub, en la
ruta
[`scripts/09_DEG_STAR_KD.R`](https://github.com/leonardoglez6/Equipo2/blob/main/scripts/01_DownloadRawData.sh).
...
![Contenido de GC](figures/fastqc_per_sequence_gc_content_plot.png)
...
![Calidad por base](figures/fastqc_per_base_sequence_quality_plot.png)

![Calidad por
secuencia](figures/fastqc_per_sequence_quality_scores_plot.png)
...
![](figures/fastqc_per_base_n_content_plot.png)
...
![Secuencias
duplicadas](figures/fastqc_sequence_duplication_levels_plot.png)
...
![Contenido de GC
(procesado)](figures/fastqc_per_sequence_gc_content_plot-01.png)
...
![Calidad por base
(procesado)](figures/fastqc_per_base_sequence_quality_plot-01.png)

![Calidad por secuencia
(procesado)](figures/fastqc_per_sequence_quality_scores_plot-01.png)
...
(procesado)](figures/fastqc_per_base_n_content_plot-01.png)
...
(procesado)](figures/fastqc_sequence_duplication_levels_plot-01.png)
